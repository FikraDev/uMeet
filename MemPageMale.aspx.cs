...
namespace uMeet
{
    public partial class MemPageMale : System.Web.UI.Page
    {
        ...
        protected void Unnamed24_Click(object sender, EventArgs e)
        {
            Response.Redirect("ContactPage.aspx");

        }

        protected void Unnamed27_Click(object sender, EventArgs e)
        {
            Response.Redirect("ContactPage.aspx");
